...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label3.Text = "ファイルを選択し、エンコードボタンをクリック。" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "選択したファイルをbase64でエンコードし、その値をテキストファイルに書き込みます。" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "テキストファイルはこの" &
    "exeと同じフォルダに[元のファイル名.txt]という名称で作成されます。"
        '
        'Label4
        '
        ...
        Me.Label6.Size = New System.Drawing.Size(394, 39)
        Me.Label6.TabIndex = 5
        Me.Label6.Text = "テキストファイルを選択し、デコードボタンをクリック。" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "選択したファイルの内容をbase64でデコードしファイルを作成します。" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "デコードしたファイルはこのexe" &
    "と同じフォルダに元のファイル名で作成されます。"
        '
        'Form2
        '
